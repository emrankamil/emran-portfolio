...
const projectData: ProjectData[] = [
  ...
  },
  {
    ...
    description:
      "A full-stack solution for class scheduling, enriched with cutting-edge algorithms.",
    techstacks: ["Django", "DRF", "React"],
  ...
  },
  {
    ...
    description:
      "An audio streaming platform crafted with Django Rest Framework and React.",
    techstacks: ["React", "Django", "DRF"],
  ...
  },
  {
    ...
    description:
      "A Dashboard app build with react, tailwind css and material ui",
    techstacks: ["React", "Tailwind Css", "Material Ui"],
  ...
  },
  {
    ...
    description:
      "A Simple Python game showcasing OOP expertise - Showcasing pure Python brilliance.",
    techstacks: ["Python", "OOP", "Game"],
